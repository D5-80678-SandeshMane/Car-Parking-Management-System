...
public class ParkingSlotServiceImpl implements ParkingSlotService {
	...
	//Get All Parking Slots
		...
		public ParkingSlots addParkingSlot(SlotDto sdto) {
			System.out.println("///////////////"+sdto.getZoneId());
			...
			System.out.println("1///////////////"+sdto.getZoneId());
			slotTobeAdded.setOccupied(false);
			slotTobeAdded.setZone(zone);
			System.out.println(slotTobeAdded.getSlotName());
			System.out.println(slotTobeAdded.getSlotId());
			slotTobeAdded = parkingSlotDao.save(slotTobeAdded);
			System.out.println("3///////////////"+sdto.getZoneId());
