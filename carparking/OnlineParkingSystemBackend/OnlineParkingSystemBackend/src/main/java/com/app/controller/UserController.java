...
public class UserController {
	...
	public User register(@RequestBody UserDto requestBody) {
		User user = new User(requestBody.getFirstName(), requestBody.getLastName(), requestBody.getMobileNo(),
				requestBody.getEmail(), requestBody.getPassword(), requestBody.getAadharNo());
	...
	public ResponseEntity<UserDtoUpdate> updateUserDetails(@RequestBody UserDtoUpdate userDto,
	...
	public String deleteCarDetails(@PathVariable(value = "userId") Integer userId,
	...
	public ParkingDetails bookParking(@RequestBody ParkingDetailsPaymentDto parkingDetailsPaymentDto,
			HttpSession session) {
